...
class ScanresponseAnnotationsTypedDict(TypedDict):
    r"""Annotations attached to the log."""


class ScanresponseAnnotations(BaseModel):
    r"""Annotations attached to the log."""
...
class ScanresponseTypedDict(TypedDict):
    ...
    annotations: NotRequired[ScanresponseAnnotationsTypedDict]
    r"""Annotations attached to the log."""
...
class Scanresponse(BaseModel):
    ...
    annotations: Optional[ScanresponseAnnotations] = None
    r"""Annotations attached to the log."""
