...
class ExtractionAnnotationsTypedDict(TypedDict):
...
class ExploitsTypedDict(TypedDict):
...
class KeywordsTypedDict(TypedDict):
...
class ExtractionTypedDict(TypedDict):
    ...
    pi_is: NotRequired[PIIsTypedDict]
    r"""The PIIs found during classification."""
    annotations: NotRequired[ExtractionAnnotationsTypedDict]
    r"""Annotations attached to the extraction."""
    ...
    exploits: NotRequired[ExploitsTypedDict]
    r"""The various exploits attempts."""
    hash: NotRequired[str]
    r"""The hash of the extraction."""
    intent: NotRequired[IntentTypedDict]
    r"""The estimated intent embodied into the text."""
...
class Extraction(BaseModel):
    ...
    pi_is: Annotated[Optional[PIIs], pydantic.Field(alias="PIIs")] = None
    r"""The PIIs found during classification."""

    annotations: Optional[ExtractionAnnotations] = None
    r"""Annotations attached to the extraction."""
