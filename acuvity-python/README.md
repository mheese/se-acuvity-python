...
<br /><br />
> [!IMPORTANT]
> This SDK is not yet ready for production use. To complete setup please follow the steps outlined in your [workspace](https://app.speakeasy.com/org/acuvity-9dx/acuvity). Delete this section before > publishing to a package manager.
...
* [create_scan](docs/sdks/apex/README.md#create_scan) - Processes the scan request.
...
s = Acuvity(
    server_url="https://65a70e71881a8d000198b3f7.acuvity.dev",
)
